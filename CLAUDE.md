...
| Autobooks | Automation Hub | `salesPurchaseBook.js` + `salesPurchaseBookLedger.js` + `salesPurchaseBookConfirm.js` + `salesPurchaseBookAnnexure.js` | `spb-` | `autobooks_books`, `autobooks_entries`, `autobooks_parties`, `autobooks_adjustments` | [autobooks](docs/modules/autobooks.md) |
