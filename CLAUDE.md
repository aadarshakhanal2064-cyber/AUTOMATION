...
- `salesPurchaseBookLedger.js` **after** `salesPurchaseBook.js` — it reads and writes that file's module state (`spbData`, `spbGroups`, `spbMergeMap`).
...
| Autobooks | Automation Hub | `salesPurchaseBook.js` + `salesPurchaseBookLedger.js` | `spb-` | `autobooks_books`, `autobooks_entries`, `autobooks_parties`, `autobooks_adjustments` | [autobooks](docs/modules/autobooks.md) |
