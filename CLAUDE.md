...
- **Still to do before a second firm can actually be onboarded:** firm identity still comes from `js/config.js`, not `org_firms` (Stage 2 app work), plus Stage 3's invitations/reset.
